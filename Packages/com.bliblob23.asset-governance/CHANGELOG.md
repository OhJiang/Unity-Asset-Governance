...
- Section-based Governance Profile navigation with an overview page, configuration counts, and focused editing for exclusions, rule states, whitelist entries, and Rule Settings.
